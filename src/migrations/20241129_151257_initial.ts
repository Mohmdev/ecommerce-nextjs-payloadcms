...
export async function up({ payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE IF NOT EXISTS "products_variants_variants" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"stripe_product_i_d" varchar,
  ...
  CREATE TABLE IF NOT EXISTS "_products_v_version_variants_variants" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"stripe_product_i_d" varchar,
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_three_item_grid" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_three_item_grid" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  DO $$ BEGIN
   ALTER TABLE "products_variants_variants" ADD CONSTRAINT "products_variants_variants_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."products"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "_products_v_version_variants_variants" ADD CONSTRAINT "_products_v_version_variants_variants_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_products_v"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  CREATE INDEX IF NOT EXISTS "users_rels_orders_id_idx" ON "users_rels" USING btree ("orders_id");
  ...
  CREATE INDEX IF NOT EXISTS "products_blocks_media_block_media_idx" ON "products_blocks_media_block" USING btree ("media_id");
  ...
  CREATE INDEX IF NOT EXISTS "products_variants_variants_order_idx" ON "products_variants_variants" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "products_variants_variants_parent_id_idx" ON "products_variants_variants" USING btree ("_parent_id");
  ...
  CREATE INDEX IF NOT EXISTS "_products_v_blocks_media_block_media_idx" ON "_products_v_blocks_media_block" USING btree ("media_id");
  ...
  CREATE INDEX IF NOT EXISTS "_products_v_version_variants_variants_order_idx" ON "_products_v_version_variants_variants" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_products_v_version_variants_variants_parent_id_idx" ON "_products_v_version_variants_variants" USING btree ("_parent_id");
  ...
  CREATE INDEX IF NOT EXISTS "pages_blocks_three_item_grid_order_idx" ON "pages_blocks_three_item_grid" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_blocks_three_item_grid_parent_id_idx" ON "pages_blocks_three_item_grid" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_three_item_grid_path_idx" ON "pages_blocks_three_item_grid" USING btree ("_path");
  ...
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_three_item_grid_order_idx" ON "_pages_v_blocks_three_item_grid" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_three_item_grid_parent_id_idx" ON "_pages_v_blocks_three_item_grid" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_three_item_grid_path_idx" ON "_pages_v_blocks_three_item_grid" USING btree ("_path");
...
export async function down({ payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "products_variants_variants" CASCADE;
  ...
  DROP TABLE "_products_v_version_variants_variants" CASCADE;
  ...
  DROP TYPE "public"."enum_products_blocks_media_block_position";
  ...
  DROP TYPE "public"."enum__products_v_blocks_media_block_position";
